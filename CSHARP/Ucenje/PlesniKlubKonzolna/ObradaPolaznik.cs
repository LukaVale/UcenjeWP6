...
namespace Ucenje.PlesniKlubKonzolna
{
    internal class ObradaPolaznik
    {
        ...
        private void PromjeniPodatakPolaznika()
        {
            ...
            odabrani.Mail = Pomocno.UcitajString("Unesi email polaznika", 50, true);
        }

        public void PrikaziPolaznike()
        {
            Console.WriteLine("*****************************");
            Console.WriteLine("Polaznici u plesnom klubu");
            int rb = 0;
        ...
        public void UnosNovogPolaznika()
        {
            ...
            Polaznici.Add(new()
            {
                ...
                Mail = Pomocno.UcitajString("Unesi email polaznika", 50, true)
            });
        }
    }
}
